...
rdp <- function(mat, view, limits) {
  ...
  if(view==1){
    ...
    plot(fistprom,alfast,xlim=c(0,xl),ylim=c(0,yl),xlab="Dispersion field",ylab="Richness normalized")
    ...
    plot(fistpromt,alfastt,xlim=c(0,xl),ylim=c(0,yl),xlab="Richness field",ylab="Proportional range")
